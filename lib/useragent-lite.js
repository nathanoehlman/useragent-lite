...
var devices = [
  ...
  { name: "Motorola Droid", flags:["isPhone"], platform: "Phone", regex: /(DROID|Droid|SHOLS_U2|XT[0-9]{4})/i },
  { name: "HTC", flags:["isPhone"], platform: "Phone", regex: /HTC One|HTC Sensation|Sprint APA9292KT/i },
  { name: "Kindle", flags:["isTablet"], platform: "Tablet", regex: /Kindle/i },
  ...
  { name: "Samsung Tablet", flags:["isTablet"], platform: "Tablet", regex: /SCH-I|GT-P/i },
